import module_6_best_practices.homework.batch as  b
...
def test_read_data():
    ...
    actual_df = b.prepare_data(df, categorical)
    expected_result = [
    ...
    print("The rows in expected dataframe are: ", len(expected_records))
